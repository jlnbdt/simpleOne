<?php include(dirname(__FILE__).'/header.php'); ?>
            <div class="txtleft titreCatArch fontBiolinum"><?php $plxShow->lang('ARCHIVES'); ?> : <?php echo plxDate::formatDate($plxShow->plxMotor->cible, '#month #num_year(4)') ?></div>
...
<div class="line txtcenter fontVerdana small"><?php $plxShow->pagination() ?></div>
